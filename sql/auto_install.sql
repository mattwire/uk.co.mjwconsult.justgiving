...
CREATE TABLE `civicrm_justgiving_fundraising_page` (
     ...
     `charity_opt_in` tinyint    COMMENT 'The charityOptIn argument allows you to indicate whether the user wishes to opt in to receive communications from the charity the fundraising page is for. (Required)',
     ...
     `charity_funded` tinyint    COMMENT 'The charityFunded argument specifies whether the charity is contributing in some way to the fundraising, which can affect Gift Aid. For more information about how Gift Aid works http://bit.ly/cZfY1R (Required)',
